...
# https://bitbucket.org/thesheep/micropython-bno055/src/b2ba261d8c5e05f2ca1a13b9179891a5bfa66569/bno055.py?at=default&fileviewer=file-view-default
...
class BNO055:
    ...
    def _registers(self, register, struct, value=None, scale=1):
        if value is None:
            ...
            print("readfrom_mem:", self.address, register, size)
